...
Une entreprise de jeu de société est en train de préparer la sortie future d’un nouveau jeu, celui-ci s’appelle Quixo. Cependant, l’entreprise ne sait pas si ce jeu va plaire et elle ne veut pas décevoir sa clientèle et veut proposer un jeu le plus qualitatif et adapté aux demandes, aux envies des clients avec l’objectif que ce jeu devienne un classique dans le monde des jeux de société au même niveau que les monopoly, puissance 4…. C’est pour cela, que l’entreprise décide de développer d’abord ce jeu dans une version el ligne  puis de créer un site web avec intégré, le jeu, les explications, et un formulaire de contact et de recommandation permettant aux visiteurs de donner leur avis afin d’améliorer le jeu après une partie. ![image](https://github.com/user-attachments/assets/87d8ebd0-4452-4bab-8250-cac3d0c0df2a)
